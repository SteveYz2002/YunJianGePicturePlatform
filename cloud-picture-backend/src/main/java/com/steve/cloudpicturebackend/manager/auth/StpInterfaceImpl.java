package com.steve.cloudpicturebackend.manager.auth;
...
import com.steve.cloudpicturebackend.manager.auth.model.SpaceUserAuthConfig;
...
import static com.steve.cloudpicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    /**
     * 返回一个账号所拥有的角色标识集合 (权限与角色可分开校验) （本项目中不用）
     */
    @Override
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if(ObjUtil.isNotNull(id)) {
            ...
            // 获取前缀的第一个斜杠前的字符串
            String moduleName = StrUtil.subBefore(partURL, "/", true);
            switch (moduleName) {
                case "picture":
