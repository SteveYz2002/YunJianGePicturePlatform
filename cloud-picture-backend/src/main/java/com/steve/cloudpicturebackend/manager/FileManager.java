package com.steve.cloudpicturebackend.manager;
...
/**
 * 文件服务
 * @deprecated 已弃用，使用upload包中的模板方法优化
 */
@Slf4j
@Service
@Deprecated
public class FileManager {
    ...
    public UploadPictureResult uploadPicture(MultipartFile multipartFile, String uploadPathPrefix) {
        ...
        try {
            ...
            double pictureScale = NumberUtil.round(pictureWidth / (double) pictureHeight, 2).doubleValue();
    ...
    private void validPicture(MultipartFile multipartFile) {
        ...
        // 允许上传的文件后缀列表
        final List<String> allowedSuffixList = Arrays.asList("jpg", "jpeg", "png", "gif", "bmp");
        ThrowUtils.throwIf(!allowedSuffixList.contains(fileSuffix), ErrorCode.PARAMS_ERROR, "文件类型不支持");
    }
