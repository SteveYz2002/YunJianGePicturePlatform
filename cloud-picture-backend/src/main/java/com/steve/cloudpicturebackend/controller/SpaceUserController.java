...
import com.steve.cloudpicturebackend.model.dto.spaceuser.SpaceUserEditRequest;
...
public class SpaceUserController {
    ...
    public BaseResponse<Long> addSpaceUser(@RequestBody SpaceUserAddRequest spaceUserAddRequest, HttpServletRequest request) {
        // 判断spaceUserAddRequest是否为空，如果为空则抛出参数错误异常
        ThrowUtils.throwIf(spaceUserAddRequest == null, ErrorCode.PARAMS_ERROR);
        // 调用spaceUserService的addSpaceUser方法，将spaceUserAddRequest作为参数传入，返回添加成员的id
    ...
    public BaseResponse<List<SpaceUserVO>> listSpaceUser(@RequestBody SpaceUserQueryRequest spaceUserQueryRequest,
                                                         HttpServletRequest request) {
        // 判断spaceUserQueryRequest是否为空，如果为空则抛出参数错误异常
        ThrowUtils.throwIf(spaceUserQueryRequest == null, ErrorCode.PARAMS_ERROR);
        // 根据spaceUserQueryRequest查询成员信息列表
