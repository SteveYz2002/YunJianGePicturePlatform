...
import com.steve.cloudpicturebackend.manager.auth.annotation.SaSpaceCheckPermission;
...
public class PictureController {
    ...
    @SaSpaceCheckPermission(value = SpaceUserPermissionConstant.PICTURE_UPLOAD)
    public BaseResponse<PictureVO> uploadAvatar(@RequestPart("file") MultipartFile multipartFile,
...
//            }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = String.format("cloud_picture:listPictureVOByPage:%s", hashKey);
        // 1. 从本地缓存中查询
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> tagList = Arrays.asList("热门", "搞笑", "生活", "艺术", "校园", "背景", "简历", "创意", "美食", "动物", "科技", "汽车", "运动", "自然", "建筑", "人物", "风景", "动漫", "游戏", "其他");
        List<String> categoryList = Arrays.asList("模板", "电商", "表情包", "素材", "海报", "头像", "背景", "插画");
