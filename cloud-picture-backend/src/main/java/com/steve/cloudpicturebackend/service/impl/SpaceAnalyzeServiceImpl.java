...
public class SpaceAnalyzeServiceImpl extends ServiceImpl<SpaceMapper, Space>
    ...
    public List<SpaceUserAnalyzeResponse> getSpaceUserAnalyze(SpaceUserAnalyzeRequest spaceUserAnalyzeRequest, User loginUser) {
        ...
        switch (timeDimension) {
            ...
            case "month":
                ...
                break;
            default: throw new BusinessException(ErrorCode.PARAMS_ERROR, "时间维度不合法");
        }
        // 分组排序
    ...
    private void checkSpaceAnalyzeAuth(SpaceAnalyzeRequest spaceAnalyzeRequest, User loginUser) {
        ...
        // 全空间分析和公共图库分析，仅管理员可以访问

        if (queryAll || queryPublic) {
            ThrowUtils.throwIf(!userService.isAdmin(loginUser), ErrorCode.NO_AUTH_ERROR, "用户无权限");
        } else {
            ...
            ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR, "空间不存在");
            // 分析特定空间，仅本人和管理员可以访问
            ThrowUtils.throwIf(!userService.isAdmin(loginUser) && !space.getUserId().equals(loginUser.getId()), ErrorCode.NO_AUTH_ERROR, "用户无权限");
        }
    }
